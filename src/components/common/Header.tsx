        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <button
              id="brand-logo-btn"
              onClick={() => handleNav('/')}
              className="flex items-center gap-3 group focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-lg text-left"
                      ...
                      <div className="space-y-0.5">
                        {SERVICES_DATA.map((srv) => (
                          <button
                            ...
                            className="w-full flex items-start gap-3 p-2.5 rounded-lg hover:bg-slate-800/70 text-left transition-colors group"
                          >
                  ...
                  <div className="absolute top-full left-0 w-84 pt-2 z-50">
                    <div className="bg-[#0b101f] border border-slate-800 rounded-xl shadow-2xl p-2 backdrop-blur-xl">
                      ...
                      <button
                        ...
                        className="w-full p-3 rounded-lg bg-gradient-to-r from-blue-950/40 to-slate-900 border border-blue-800/40 hover:border-blue-500/60 text-left transition-all group mb-1.5"
                      >
                      ...
                      <div className="space-y-0.5">
                        <button
                          onClick={() => handleNav('/products')}
                          className="w-full flex items-center justify-between p-2.5 rounded-lg hover:bg-slate-800/70 text-left transition-colors group"
                        >
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-slate-300 hover:text-white rounded-lg border border-slate-800 hover:border-slate-700 bg-slate-900/60 hover:bg-slate-800/80 transition-all shadow-sm"
              >
              ...
              <button
                ...
                onClick={() => handleNav('/contact')}
                className="relative group overflow-hidden rounded-lg p-[1px] font-semibold text-xs shadow-md shadow-blue-500/20 hover:shadow-blue-500/40 transition-shadow focus:outline-none focus:ring-2 focus:ring-blue-400"
              >
            ...
            <div className="flex items-center gap-2 lg:hidden">
              ...
              <button
                ...
                className="p-2 text-slate-300 hover:text-white bg-slate-900 border border-slate-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
