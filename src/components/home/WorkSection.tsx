      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-2xl sm:text-4xl font-extrabold text-white tracking-tight">
            Our Work & Architectural Case Studies
          </h2>
              ...
              <div>
                ...
                <div className="mt-4 flex flex-wrap gap-1.5 pt-3 border-t border-slate-800/80">
                  {project.techStack.slice(0, 4).map((tech, tIdx) => (
                    <span
                      key={tIdx}
                      className="text-[10px] px-2 py-0.5 rounded bg-slate-950 text-slate-300 border border-slate-800/90 font-mono"
                    >
                      {tech}
                    </span>
                  ))}
