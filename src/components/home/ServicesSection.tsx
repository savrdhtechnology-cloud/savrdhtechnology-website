    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {SERVICES_DATA.map((service, idx) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className={`group relative rounded-2xl bg-gradient-to-b from-slate-900/90 to-[#080d1a] border border-slate-800/90 p-7 shadow-lg transition-all duration-300 ${getServiceBorderGradient(
                idx
        ...
        <motion.div
          ...
          className="mt-12 p-6 rounded-2xl bg-gradient-to-r from-blue-950/30 via-slate-900/40 to-slate-950 border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4"
        >
          <div>
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-lg bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/40 text-blue-300 text-xs font-bold whitespace-nowrap transition-colors cursor-pointer"
          >
