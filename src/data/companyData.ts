import { ServiceItem, ProductItem, PortfolioItem, TechCapability, ClientItem, DownloadItem, PricingPackage, DiscountCampaign } from '../types';

export const DEFAULT_DISCOUNT_CAMPAIGN: DiscountCampaign = {
  isEnabled: true,
  percentage: 10,
  campaignTitle: 'Seasonal Tech Growth Offer',
  promoCode: 'SAVRDH10',
  bannerText: 'Special Festive Offer: Get Flat 10% OFF on all Software Packages & Project Kick-off Booking!',
  validUntilNote: 'Limited Time Offer • Automatically Applied at Checkout',
  applyToTokenFee: true,
};

export const COMPANY_PAYMENT_INFO = {

  companyName: 'Savrdh Technologies',
  upiId: '8109995906@paytm',
  secondaryUpiId: 'savrdhtechnologies@okaxis',
  primaryPhoneNumber: '8109995906',
  bankName: 'HDFC Bank Ltd',
  accountNumber: '50200081099959',
  ifscCode: 'HDFC0001234',
  accountType: 'Current Account',
  accountHolderName: 'Savrdh Technologies',
  branch: 'Commercial Tech Hub Branch',
  upiQrBaseUrl: 'https://api.qrserver.com/v1/create-qr-code/?size=260x260&margin=1&data=',
  tokenGuaranteeNote: '100% Adjustable Against Final Invoice. Zero Risk & Immediate Dedicated Architect Allocation.',
};

export const PRICING_PACKAGES: PricingPackage[] = [
  {
    id: 'starter-corporate-web',
    name: 'Starter Corporate Website',
    category: 'Website',
    badge: 'Fast Turnaround • High ROI',
    ...
    targetAudience: 'Small to Mid-size Businesses, Startups, Service Companies, Doctors & Law Firms',
    description:
      'A sleek, mobile-responsive, lightning-fast corporate website designed to establish high credibility, showcase products & services, and convert inbound visitors into high-intent leads.',
    idealFor: 'Businesses wanting a high-converting corporate presence with SEO and speed.',
    deliverables: [
      '5 to 8 Custom Designed Responsive Pages',
      'Mobile-First Architecture (iOS & Android optimized)',
      'Lead Capture Contact Forms with WhatsApp & Email alerts',
      'On-Page Technical SEO & Schema Markup',
      'Free SSL Certificate & 1 Year Cloud Hosting Setup',
      'Admin Training & Full Source Code Handover',
    ],
    techStack: ['React', 'Next.js / Vite', 'Tailwind CSS', 'Cloudflare CDN', 'Nginx'],
    features: [
      'Sub-second page load times',
      'Interactive Google Maps & Direct WhatsApp Floating Button',
  ...
  {
    id: 'advanced-web-app',
    name: 'Growth Enterprise Web App & Portal',
    category: 'WebApp',
    popular: true,
    badge: 'Most Popular • Full-Stack Platform',
    priceRange: '₹64,999 – ₹1,35,000',
    minPrice: 64999,
    maxPrice: 135000,
    tokenBookingFee: 1999,
    tokenDescription: 'Sprint 1 Architecture Consultation & Token Advance (100% Adjusted in Final Bill)',
    deliveryTimeline: '2 – 3 Weeks',
    targetAudience: 'Growing Companies, FinTechs, E-Commerce, Real Estate & Logistics Portals',
    description:
      'Custom database-driven web application with user accounts, secure role-based access control (RBAC), administrative command center, payment gateways, and custom business workflows.',
    idealFor: 'Businesses needing internal operations portals, customer dashboards, or automated workflows.',
    deliverables: [
      'Custom Database Architecture (PostgreSQL / MongoDB)',
      'Secure User Authentication & Multi-Role Permissions (Admin, Staff, Customer)',
      'Rich Analytics & Administrative Control Dashboard',
      'Payment Gateway Integration (Razorpay, Stripe, Cashfree, UPI)',
      'Automated Email & SMS Notifications Pipeline',
      '100% Source Code & API Documentation Handover',
    ],
    techStack: ['React / Vue', 'Node.js / Express / Python FastAPI', 'PostgreSQL', 'Docker', 'AWS / Cloud Run'],
    features: [
      'Custom Reporting & CSV/PDF Export',
      '99.9% Uptime High-Availability Cloud Setup',
      'Bank-grade SSL encryption & OWASP security',
      '60-Day Post-Launch Free Warranty & Support',
    ],
  },
  {
    ...
    category: 'MobileApp',
    badge: 'Cross-Platform • Store Ready',
    priceRange: '₹1,15,000 – ₹2,45,000',
    minPrice: 115000,
    maxPrice: 245000,
    tokenBookingFee: 2999,
    tokenDescription: 'App Blueprint & UI Prototype Booking Token (100% Adjusted in Final Bill)',
    deliveryTimeline: '3 – 4 Weeks',
    targetAudience: 'D2C Brands, On-Demand Services, Field Mobility, Delivery & Customer Apps',
    description:
      'Native-feel mobile apps engineered for both Android (Google Play Store) and iOS (Apple App Store) with real-time sync, push notifications, offline caching, and intuitive user UX.',
    idealFor: 'Companies needing customer-facing or internal operational mobile apps.',
    deliverables: [
      'Dual Platform Android (APK/AAB) & iOS (IPA) Build',
      ...
      'Live Location / GPS Mapping & Camera Integration',
      'Admin Web Portal to manage app data and users',
    ],
    techStack: ['Flutter / React Native', 'Node.js Backend', 'Firebase / Redis', 'Google Cloud Platform'],
    features: [
      'Biometric Fingerprint / FaceID Login',
      'In-App Payment Gateway & Order Tracking',
      'Crashlytics & Real-time telemetry monitoring',
      '90-Day Post-Launch Technical SLA Warranty',
    ],
  },
  {
    id: 'fieldsure-saas-enterprise',
    name: 'FieldSure™ SaaS & Custom Enterprise ERP',
    category: 'SaaS',
    badge: 'Enterprise Flagship • Unlimited Scale',
    priceRange: '₹1,85,000 – ₹4,50,000+',
    minPrice: 185000,
    maxPrice: 450000,
    tokenBookingFee: 4999,
    tokenDescription: 'Enterprise Scope & Solution Architecture Token (100% Adjusted in Final Bill)',
    deliveryTimeline: '3 – 6 Weeks (or Instant SaaS Deploy)',
    targetAudience: 'Enterprises with 10–500+ Field Staff, Logistics, Inspection, Security & Service Teams',
    description:
      'Complete field workforce management suite: GPS tracking, geofenced selfie attendance, automated daily allowance, route optimization, inspection forms, and ERP sync (SAP/Tally/Oracle).',
    idealFor: 'Organisations wanting complete operational visibility and zero employee attendance leakage.',
    deliverables: [
      'FieldSure™ Admin Command Center + Android Field Mobile APK',
      'Geofenced Attendance with Anti-Mock GPS & Offline Sync',
      'Live Team Tracking & Route Distance Traveled Engine',
      'Custom Task Assignment & Client Visit Proof forms',
      'Automated Travel Allowance (TA/DA) Calculation',
      'Custom ERP API Connectors & Dedicated Database Isolation',
    ],
    techStack: ['Node.js Cluster', 'React Command Center', 'Flutter Mobile Engine', 'PostGIS', 'Redis', 'AWS'],
    features: [
      'Unlimited Field Executives & Managers',
      'DPDP Compliant & ISO 27001 Aligned Security',
      'Dedicated Account Manager & Priority 24/7 Phone SLA',
      'Free On-Premises or Dedicated Cloud Server Deployment',
    ],
  },
  {
    id: 'tech-architecture-consultation',
    name: '1-on-1 Deep-Dive Tech Consultation & Scope Blueprint',
    category: 'Consultation',
    badge: 'Immediate Booking • 100% Actionable',
    priceRange: '₹499 Fixed',
    minPrice: 499,
    maxPrice: 499,
    tokenBookingFee: 499,
    tokenDescription: 'Direct Consultation Fee for 45-Min 1-on-1 Session with Senior Solution Architect',
    deliveryTimeline: 'Same-Day / Next-Day Slot Available',
    targetAudience: 'Founders, CTOs, Business Owners & Product Managers planning a new software project',
    description:
      'A dedicated 45-minute technical discovery and architecture review session with our Senior Engineering Director. We dissect your idea, evaluate tech stacks, identify security risks, and give you a comprehensive Project Scope Document (SOW).',
    idealFor: 'Clients wanting expert advice, realistic cost estimation, and tech stack clarity before investing.',
    deliverables: [
      '45-Minute 1-on-1 Video / Audio Consultation Call',
      'Detailed Technical Architecture Recommendation',
      'Feasibility Analysis & Risk Assessment Report',
      'Itemized Scope of Work (SOW) & Cost Roadmap',
      '100% Fee Adjustment if you proceed with development with Savrdh',
    ],
    techStack: ['Architecture Design', 'Database Modeling', 'API Strategy', 'Cost Optimization'],
    features: [
      'Same-day or next-day flexible scheduling',
      'Direct interaction with Principal Architect (No sales reps)',
      'Zero obligation to build with us',
      'Follow-up summary sent on WhatsApp & Email within 2 hours',
    ],
  },
];
...
export const DOWNLOADS_DATA: DownloadItem[] = [
  // --- Savrdh CRM ---
  {
    id: 'savrdh-crm-mobile-apk',
    title: 'Savrdh CRM Field Mobility & Sales Companion APK',
    productName: 'Savrdh CRM',
    category: 'Mobile APK / App Demo',
    version: 'v3.2.0 (Stable Enterprise)',
    releaseDate: 'August 2026',
    fileSize: '31.5 MB',
    platform: 'Android 8.0+ / Mobile Application',
    badge: 'Popular CRM App',
    description:
      'The official mobile companion for Savrdh CRM. Empowers field sales representatives with offline-first deal pipelines, 1-click WhatsApp Business messaging, automatic call log synchronization, and GPS-verified client check-ins.',
    features: [
      'Offline Lead Management & Kanban Deal Stage Mover',
      'Direct WhatsApp Template Integration with 1-tap dispatch',
      'Auto-logging of outbound calls, talk durations, and disposition notes',
      'Geo-stamped client meeting check-in & visit audit trails',
      'Instant quote generation & digital brochure sharing',
    ],
    downloadFileName: 'Savrdh_CRM_Mobile_Sales_v3.2.0.apk',
    checksum: 'SHA-256: d4a2f8b9e1c3a7d5f0b2e4c6a8f1b3d5e7c9a1b3d5f7e9a2c4b6d8f0a2c4e6b8',
    demoUrl: '/products/savrdh-crm',
    instructions: [
      'Download and install the APK on an Android smartphone or tablet.',
      'Enable "Install unknown apps" permission for your browser in Settings if requested.',
      'Launch Savrdh CRM. Use demo credentials `demo@savrdh.com` / `demo1234` or sign in with your enterprise account.',
      'Test offline lead creation, customer dialler sync, and WhatsApp template triggers.',
    ],
  },
  {
    id: 'savrdh-crm-telephony-desktop',
    title: 'Savrdh CRM Desktop Telephony & Agent Dialer Workstation',
    productName: 'Savrdh CRM',
    category: 'Desktop / TV Wall App',
    version: 'v3.2.0 (Windows & Mac)',
    releaseDate: 'August 2026',
    fileSize: '46.8 MB',
    platform: 'Windows 10/11 & macOS Desktop',
    badge: 'Call Center Tool',
    description:
      'High-performance desktop dialer and telephony bar for telesales agents and customer support desks. Integrates directly with Exotel, Twilio, Tata Tele, and SIP PBX for zero-lag pop-up caller profiles and call recordings.',
    features: [
      'Incoming Call Screen Pop with instant customer timeline and CRM history',
      'Predictive & Progressive auto-dialer queue execution',
      '1-click live call recording sync and post-call disposition tagging',
      'Custom headset shortcut keybinds and mute/transfer controls',
    ],
    downloadFileName: 'Savrdh_CRM_Telephony_Dialer_v3.2.0_Setup.exe',
    checksum: 'SHA-256: 7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a',
    demoUrl: '/products/savrdh-crm',
    instructions: [
      'Run the setup executable on your agent workstation.',
      'Authenticate with your Savrdh CRM company domain and agent credentials.',
      'Select your audio input/output devices and start handling inbound/outbound queues.',
    ],
  },

  // --- FieldSure™ Enterprise SaaS ---
  {
    id: 'fieldsure-mobile-apk',
    title: 'FieldSure™ Mobile Companion APK (Demo & Production)',
    productName: 'FieldSure™ Enterprise SaaS',
    category: 'Mobile APK / App Demo',
    version: 'v2.4.1 (Stable Release)',
    releaseDate: 'August 2026',
    fileSize: '28.4 MB',
    platform: 'Android 8.0+ / Enterprise APK',
    badge: 'Flagship Mobile APK',
    description:
  ...
  },
  {
    ...
    title: 'FieldSure™ Web Command Center Client Suite',
    productName: 'FieldSure™ Enterprise SaaS',
    category: 'Web Command Center',
    version: 'v2.4.0 (Cloud Web Release)',
    releaseDate: 'August 2026',
    fileSize: '18.2 MB / Cloud SaaS',
    ...
    demoUrl: '/demo/fieldsure',
    instructions: [
      'Extract the ZIP or click Launch Web Demo to access the live command environment.',
  ...
  // --- Savrdh Credit & Lending ---
  {
    id: 'savrdh-credit-resolution-apk',
    title: 'Savrdh Credit Resolution Mobile Operations APK',
    productName: 'Savrdh Credit',
    category: 'Mobile APK / App Demo',
    version: 'v1.6.2 (Enterprise Mobile)',
    releaseDate: 'August 2026',
    fileSize: '24.1 MB',
    platform: 'Android 9.0+ / Mobile Application',
    badge: 'FinTech Field App',
    description:
  ...
  {
    id: 'savrdh-credit-los-suite',
    title: 'Savrdh Credit Loan Origination (LOS) Underwriting Portal Bundle',
    productName: 'Savrdh Credit',
    category: 'Web Command Center',
    version: 'v2.1.0',
    releaseDate: 'August 2026',
    fileSize: '19.4 MB',
    platform: 'Web Application / Node.js & Docker Bundle',
    badge: 'Underwriting Engine',
    description:
      'Digital Loan Origination and rule-based underwriting workstation. Features automated e-KYC validation, Account Aggregator bank statement analytics, credit bureau score ingestion, and instant sanction letter generator.',
    features: [
      'Paperless Aadhaar OTP & PAN verification with OCR parser',
      'Account Aggregator 6-month bank statement cash-flow analyzer',
      'Configurable FOIR, DTI, and credit risk scorecard thresholds',
      'Instant PDF Sanction Letter and IT-Act compliant eSign triggers',
    ],
    downloadFileName: 'Savrdh_Credit_LOS_Suite_v2.1.zip',
    checksum: 'SHA-256: e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9',
    demoUrl: '/products/savrdh-credit',
    instructions: [
      'Extract the package or launch via Docker container.',
      'Configure test bureau API keys or enable Sandbox Mock Bureau mode.',
      'Submit a loan application to test real-time algorithmic decisioning.',
    ],
  },

  // --- Savrdh ERP ---
  {
    id: 'savrdh-erp-scanner-apk',
    title: 'Savrdh ERP Warehouse Barcode Scanner & Handheld PDA APK',
    productName: 'Savrdh ERP',
    category: 'Mobile APK / App Demo',
    version: 'v2.0.4 (Industrial Android)',
    releaseDate: 'August 2026',
    fileSize: '18.6 MB',
    platform: 'Android 8.0+ / Zebra, Honeywell, Urovo & Standard Android',
    badge: 'Warehouse Scanner',
    description:
      'Engineered for warehouse workers, floor supervisors, and dispatch dispatchers. Supports 1D/2D hardware laser barcode scanners and smartphone cameras for rapid Goods Receipt (GRN), lot/batch picking, and inter-branch transfers.',
    features: [
      'Instant barcode & QR scanning with sub-100ms camera decoder',
      'Goods Receipt (GRN) verification against active Purchase Orders',
      'Bin-to-bin stock transfer and physical cycle-count audits',
      'Batch, serial number, and manufacturing/expiry date validation',
      'Full offline mode for metal-roofed warehouses with auto-sync',
    ],
    downloadFileName: 'Savrdh_ERP_Warehouse_Scanner_v2.0.apk',
    checksum: 'SHA-256: 4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c',
    demoUrl: '/products/savrdh-erp',
    instructions: [
      'Install APK on your warehouse Android smartphone or industrial PDA terminal.',
      'Open app and scan your Savrdh ERP Warehouse Station pairing QR code.',
      'Scan product barcodes to record inwards stock and generate GRN receipts.',
    ],
  },
  {
    id: 'savrdh-erp-desktop-pos',
    title: 'Savrdh ERP Desktop Station & Offline Factory Terminal Client',
    productName: 'Savrdh ERP',
    category: 'Desktop / TV Wall App',
    version: 'v2.0.0 (Windows x64)',
    releaseDate: 'August 2026',
    fileSize: '54.2 MB',
    platform: 'Windows 10/11 (64-bit) POS & Billing Terminals',
    badge: 'Factory Terminal',
    description:
      'High-speed desktop billing and factory operations terminal. Engineered to run offline during network downtime, print thermal GST invoices, manage cash drawers, and sync sales ledgers whenever the internet connects.',
    features: [
      'Offline-capable GST e-Invoice generation with QR code printing',
      'ESC/POS Thermal receipt printer & weighing scale hardware drivers',
      'Production work order checklist & machine operator job logging',
      'Instant double-entry ledger debit/credit postings',
    ],
    downloadFileName: 'Savrdh_ERP_Station_POS_v2.0_Setup.exe',
    checksum: 'SHA-256: 6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b',
    demoUrl: '/products/savrdh-erp',
    instructions: [
      'Run the installer on your billing counter or shop-floor PC.',
      'Select your company warehouse branch and default thermal invoice printer.',
      'Process transactions seamlessly with zero internet dependence.',
    ],
  },

  // --- Savrdh Partner ---
  {
    id: 'savrdh-partner-mobile-apk',
    title: 'Savrdh Partner Channel Network & Commission Mobile APK',
    productName: 'Savrdh Partner',
    category: 'Mobile APK / App Demo',
    version: 'v1.4.2',
    releaseDate: 'August 2026',
    fileSize: '22.4 MB',
    platform: 'Android 8.0+ / Mobile Application',
    badge: 'Partner Network App',
    description:
      'White-labeled self-service mobile app for distributors, direct selling agents (DSAs), brokers, and affiliates. Register customer leads, monitor deal progression in real time, view earned commissions, and request instant bank/UPI withdrawals.',
    features: [
      'Conflict-free lead registration with instant 90-day ownership locking',
      'Live deal pipeline stage tracking & notifications upon client closure',
      'Transparent commission passbook with automated TDS deduction breakdown',
      'Instant 1-tap UPI and IMPS withdrawal requests',
      'Co-branded marketing brochures & collateral sharing center',
    ],
    downloadFileName: 'Savrdh_Partner_Network_v1.4.2.apk',
    checksum: 'SHA-256: 2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d',
    demoUrl: '/products/savrdh-partner',
    instructions: [
      'Install APK on your Android device.',
      'Log in with partner mobile number or test using Demo Partner ID `partner_gold_108`.',
      'Register a test customer lead and explore the real-time commission ledger.',
    ],
  },

  // --- Savrdh AI ---
  {
    id: 'savrdh-ai-desktop-copilot',
    title: 'Savrdh AI Enterprise Desktop Copilot & Document Assistant',
    productName: 'Savrdh AI',
    category: 'Desktop / TV Wall App',
    version: 'v1.2.0 (Windows & macOS Universal)',
    releaseDate: 'August 2026',
    fileSize: '38.4 MB',
    platform: 'Windows 10/11 & macOS Universal',
    badge: 'Enterprise AI Assistant',
    description:
      'Private enterprise generative AI desktop client. Summon with Alt+Space or Cmd+Space to query company internal policy documents, analyze financial spreadsheets, draft compliant emails, and extract data from complex PDFs with zero data leakage.',
    features: [
      'System-wide global hotkey overlay (Alt+Space / Cmd+Space)',
      'Drag-and-drop 100+ page PDF, Excel, and Word document parser',
      'Private enterprise RAG grounded strictly in internal verified company documents',
      'Zero Data Retention (ZDR) guarantee — no data used for public LLM training',
      'Multilingual translation and tone adapter for business communications',
    ],
    downloadFileName: 'Savrdh_AI_Copilot_Desktop_v1.2.0.exe',
    checksum: 'SHA-256: 5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a',
    demoUrl: '/products/savrdh-ai',
    instructions: [
      'Install on your desktop workstation.',
      'Enter your Savrdh AI enterprise tenant key or click "Sandbox Preview".',
      'Press Alt+Space anytime to query documents or draft customer communications.',
    ],
  },
  {
    id: 'savrdh-ai-developer-sdk',
    title: 'Savrdh AI Enterprise Python & Node.js Developer SDK',
    productName: 'Savrdh AI',
    category: 'Documentation & SDK',
    version: 'v1.2.0 SDK',
    releaseDate: 'August 2026',
    fileSize: '6.4 MB',
    platform: 'Python 3.9+, Node.js 18+, REST API, WebSockets',
    badge: 'AI Developer SDK',
    description:
      'Comprehensive SDK for integrating private enterprise generative AI into your software applications. Includes low-latency multilingual voice bot streaming protocols, document OCR extraction pipelines, and RAG vector search helpers.',
    features: [
      'Full Python & TypeScript/Node.js type-safe client libraries',
      'Bi-directional WebSocket streaming clients for sub-800ms voice agents',
      'Structured JSON extraction schemas for invoices, balance sheets, and KYC IDs',
      'Ready-to-deploy Docker microservice reference templates',
    ],
    downloadFileName: 'Savrdh_AI_SDK_Developer_Kit_v1.2.tar.gz',
    checksum: 'SHA-256: 8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b',
    demoUrl: '/products/savrdh-ai',
    instructions: [
      'Extract tarball or install via `pip install savrdh-ai-sdk` / `npm install @savrdh/ai-sdk`.',
      'Follow the included `examples/voice_agent_stream.py` and `examples/document_parser.ts`.',
      'Connect securely using your enterprise API secret token.',
    ],
  },

  // --- Savrdh Quant ---
  {
    id: 'savrdh-quant-terminal',
    title: 'Savrdh Quant Algorithmic Trading Execution Terminal',
    productName: 'Savrdh Quant',
    category: 'Desktop / TV Wall App',
    version: 'v2.8.0 (x64 Low-Latency)',
    releaseDate: 'August 2026',
    fileSize: '48.2 MB',
    platform: 'Windows 10/11 (64-bit) & Linux (x86_64)',
    badge: 'Quant Trading Terminal',
    description:
      'Sub-15ms multi-broker execution workstation for quantitative traders, prop desks, and hedge funds. Unifies Zerodha Kite, Angel One, Dhan, Upstox, and Interactive Brokers into a single high-speed execution matrix with real-time options Greeks and risk kill switches.',
    features: [
      'Unified multi-broker order execution routing with sub-15ms latency',
      'Live real-time Options Greeks (Delta, Gamma, Theta, Vega) calculations',
      '1-Click Emergency Kill Switch to square off all broker positions simultaneously',
      'TradingView Webhook listener and Python Jupyter algorithm bridge',
      'Multi-account master-slave order copying with custom lot multipliers',
    ],
    downloadFileName: 'Savrdh_Quant_Algo_Terminal_v2.8.0.exe',
    checksum: 'SHA-256: 3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b',
    demoUrl: '/products/savrdh-quant',
    instructions: [
      'Download and run the installer on your low-latency trading workstation.',
      'Configure your broker API keys or launch in "Paper Trading Simulation" mode.',
      'Monitor live market streams, options payoffs, and automated strategy executions.',
    ],
  },
  {
    id: 'savrdh-quant-backtest-kit',
    title: 'Savrdh Quant Python Strategy Backtesting & Jupyter Starter Kit',
    productName: 'Savrdh Quant',
    category: 'Documentation & SDK',
    version: 'v2.8.0 Quant Kit',
    releaseDate: 'August 2026',
    fileSize: '14.8 MB',
    platform: 'Python 3.10+, Jupyter Notebook, Pandas, NumPy',
    badge: 'Quant Research Kit',
    description:
      'Professional quantitative research pack. Includes tick-level and 1-minute historical sample datasets, automated straddle/strangle options templates, Monte Carlo simulation scripts, and Sharpe/Sortino risk reporting notebooks.',
    features: [
      'Jupyter notebooks for testing delta-neutral options strategies',
      'High-speed vectorised backtesting engine with realistic slippage modeling',
      'Automated performance metric generator (Max Drawdown, Win Rate, CAGR, Sharpe)',
      '1-click export from Python research to live Savrdh Quant execution webhook',
    ],
    downloadFileName: 'Savrdh_Quant_Python_Backtest_Kit_v2.8.zip',
    checksum: 'SHA-256: 1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b',
    demoUrl: '/products/savrdh-quant',
    instructions: [
      'Extract the ZIP bundle and open in VS Code or JupyterLab.',
      'Run `pip install -r requirements.txt` to install quant dependencies.',
      'Execute `01_straddle_backtest.ipynb` to evaluate sample 5-year historical strategy results.',
    ],
  },

  // --- Savrdh Core Architecture & Whitepapers ---
  {
    id: 'savrdh-enterprise-whitepaper',
    title: 'Savrdh Technologies Enterprise Architecture & Security Whitepaper',
    productName: 'Savrdh Technologies Core Architecture',
