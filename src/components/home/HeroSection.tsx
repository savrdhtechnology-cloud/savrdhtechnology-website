  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[400px] bg-gradient-to-tr from-blue-600/20 via-indigo-600/15 to-cyan-500/10 blur-[120px] pointer-events-none rounded-full"
      />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-slate-800 text-slate-300 text-xs font-semibold shadow-sm mb-6 backdrop-blur-md"
          >
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white max-w-4xl leading-[1.15]"
          >
          ...
          <motion.div
            ...
            className="mt-6 flex items-center justify-center gap-3 text-xs sm:text-sm text-slate-400 font-medium"
          >
